...
export const homePage = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'heroExpandNote',
      title: 'Hero expand note',
      type: 'text',
      rows: 2,
      group: 'hero',
      description: 'Muted line under the hero subhead, above the CTAs',
    }),
    defineField({
      name: 'marqueeItems',
    ...
    defineField({
      name: 'programsPrimary',
      title: 'Programs we specialize in',
      type: 'array',
      group: 'content',
      of: [defineArrayMember({type: 'string'})],
    }),
    defineField({name: 'programsSecondaryHeading', type: 'string', group: 'content'}),
    defineField({
      name: 'programsSecondary',
      title: 'Programs we also market',
      type: 'array',
      group: 'content',
      of: [defineArrayMember({type: 'string'})],
    }),
    defineField({name: 'programsClosing', type: 'text', rows: 2, group: 'content'}),
    ...
    defineField({name: 'compareEyebrow', type: 'string', group: 'content'}),
    defineField({name: 'compareTitle', type: 'string', group: 'content'}),
    defineField({name: 'compareWithoutLabel', type: 'string', group: 'content'}),
    defineField({name: 'compareWithLabel', type: 'string', group: 'content'}),
    defineField({
      name: 'compareRows',
      title: 'Without / With comparison rows',
      type: 'array',
      group: 'content',
      of: [defineArrayMember({type: 'compareRow'})],
    }),
    defineField({name: 'teamEyebrow', type: 'string', group: 'content'}),
    defineField({name: 'teamTitle', type: 'string', group: 'content'}),
    defineField({name: 'teamSubhead', type: 'text', rows: 2, group: 'content'}),
    defineField({
      name: 'teamMembers',
      title: 'Home team strip',
      type: 'array',
      group: 'content',
      of: [defineArrayMember({type: 'personCard'})],
    }),
    defineField({name: 'teamCtaLabel', type: 'string', group: 'content'}),
    defineField({name: 'teamCtaHref', type: 'string', group: 'content'}),
    defineField({name: 'teamSecondaryLabel', type: 'string', group: 'content'}),
    defineField({name: 'teamSecondaryHref', type: 'string', group: 'content'}),
